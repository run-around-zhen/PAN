...
def main():
    ...
    parser.add_argument('--lb', dest='lb', action='store',
                        default='conga', help="fecmp/pecmp/drill/conga (default: fecmp)")
    ...
    parser.add_argument('--netload', dest='netload', action='store', type=int,
                        default=50, help="Network load at NIC to generate traffic (default: 40.0)")
    ...
    if lb_mode == 9 or lb_mode == 10 or lb_mode == 3 or lb_mode == 6: # ConWeave Logging
        ################################################################
